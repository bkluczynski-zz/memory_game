...
class App extends Component {
    ...
    render() {
        const {counter, deck, modal} = this.state;
        return (
            <div className="container">
                <header>
                    <h1>Matching Game</h1>
                </header>
                <Stars counter={counter} deck={deck} reset={this.reset}/>
                <ModalWinner modal={modal} deck={deck} closeModal={this.closeModal} counter={counter}/>
